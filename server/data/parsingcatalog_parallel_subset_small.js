module.exports = {
  "name": "Sample Workflow 'Parsing catalog & Parallel Subsetting (small)'",
  "tasks": [{
    "name": "ParsingCatalog",
    "provider": "malleefowl",
    "identifier": "thredds_urls",
    "inputs": {
      "url": `https://${process.env.BIRDHOUSE_HOST}/twitcher/ows/proxy/thredds/catalog/birdhouse/ouranos/subdaily/aet/pcp/catalog.xml`
    },
    "progress_range": [0, 10]
  }],
  "parallel_groups": [{
